...
status: draft
owner: "evan"
tags: [phase2, delivery, dashboard, ux]
created: 2026-05-17
updated: 2026-05-17
---
...
- [ ] Given 列表页, When 等待 5 秒, Then 列表自动刷新
...
| 产物未生成 | workflow 还在 running | 相应区域显示 loading 或"待生成" |
| 提交失败 | API 返回 4xx/5xx | 表单显示错误信息，不跳转 |

## 产品约束

- 纯前端 SPA，不需要 SSR
- 通过 Vite proxy 访问后端 API（开发模式）
